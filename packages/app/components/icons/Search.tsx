...
export default function SearchIcon(props: Omit<IconProps, 'children'>) {
  return (
    <Icon {...props}>
      ...
      9.5,16A6.5,6.5 0 0,1 3,9.5A6.5,6.5 0 0,1 9.5,3M9.5,5C7,5 5,7 5,9.5C5,12 7,14 9.5,14C12,14
